...
export const JobHistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myFullstackAppApp.jobHistory.delete.question">
        <Translate contentKey="myFullstackAppApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>

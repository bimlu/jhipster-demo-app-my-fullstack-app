...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myFullstackAppApp.location.delete.question">
        <Translate contentKey="myFullstackAppApp.location.delete.question" interpolate={{ id: locationEntity.id }}>

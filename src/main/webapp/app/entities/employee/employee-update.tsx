  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myFullstackAppApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="myFullstackAppApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('myFullstackAppApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('myFullstackAppApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('myFullstackAppApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('myFullstackAppApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('myFullstackAppApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('myFullstackAppApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('myFullstackAppApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('myFullstackAppApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('myFullstackAppApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments

...
export const EmployeeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myFullstackAppApp.employee.delete.question">
        <Translate contentKey="myFullstackAppApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>

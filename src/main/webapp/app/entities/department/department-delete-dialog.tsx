...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="myFullstackAppApp.department.delete.question">
        <Translate contentKey="myFullstackAppApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>

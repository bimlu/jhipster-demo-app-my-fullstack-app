...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2022-06-06T04:41').should('have.value', '2022-06-06T04:41');

      cy.get(`[data-cy="endDate"]`).type('2022-06-05T18:49').should('have.value', '2022-06-05T18:49');
